...
class UnitTestCase(unittest.TestCase):
    ...
    def test_guesses_to_solve(self):
        ...
        gtoc = solver.get_suggestion_exp(knowledge, self.prev_guesses)
    ...
    def test_guesses_to_solve_count(self):
        ...
        guess = "salet"
        solver = Solver(answers, guesses)
        knowledge = Knowledge.update_knowledge(knowledge, "prick", guess)
        gtoc = solver.get_suggestion_exp(knowledge, self.prev_guesses + tuple([guess]))
